...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
	...
	<div class="row">
		<div class="col-lg-12" style="float:left">
			<h1 class="page-header" style="float:left">Analytics </h1><div class="pull-right"><section id="auth-button" style="float:right; margin-top:40px"></section></div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			...
			<div class="Chartjs">
			  <h3>Questa settimana vs Scorsa settimana (per sessione)</h3>
			  <figure class="Chartjs-figure" id="chart-1-container"></figure>
			  <ol class="Chartjs-legend" id="legend-1-container"></ol>
			</div>
			<div class="Chartjs">
			  <h3>Questo anno vs Anno scorso (per utenti)</h3>
			  <figure class="Chartjs-figure" id="chart-2-container"></figure>
			  <ol class="Chartjs-legend" id="legend-2-container"></ol>
			</div>
			<div class="Chartjs">
			  <h3>Top Browser (per visualizzazioni pagina)</h3>
			  <figure class="Chartjs-figure" id="chart-3-container"></figure>
			  <ol class="Chartjs-legend" id="legend-3-container"></ol>
			</div>
			<div class="Chartjs">
			  <h3>Top Stati (per sessione)</h3>
...
gapi.analytics.ready(function() {
  ...
  gapi.analytics.auth.authorize({
    ...
    clientid: '508228597913-9m9oen0bbm4on6954p2082htom8214km.apps.googleusercontent.com'
  });
